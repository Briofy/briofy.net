        ...
        <div class="flex flex-col justify-center">
          <div>
            ...
            <div class="mt-12 space-y-6">
              <div v-for="feature in item.features" class="flex items-center gap-6">
                <div
                  class="flex h-20 w-20 rounded-3xl border border-gray-200 bg-white p-4 dark:border-gray-600/60 dark:bg-gray-900/40">
                  <img class="m-auto h-8 w-auto" :src="feature.img" alt="icon illustration" loading="lazy" width="512"
                    height="512" />
                </div>
