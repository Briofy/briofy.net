    ...
    <div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      <div class="relative">
        <h1 class="text-center text-5xl font-bold text-blue-900 dark:text-white sm:text-6xl lg:text-left lg:text-7xl">
          Design, Build,
          <span class="relative">
            <svg class="absolute inset-x-0 -bottom-1 w-full opacity-50" style="fill: #957fef"
            ...
            <span
              class="bg-gradient-to-r from-blue-600 to-violet-500 relative bg-clip-text dark:from-blue-600 dark:to-violet-500 text-transparent md:px-2">Scale</span>
          </span>
        </h1>

        <div class="relative items-center gap-12 lg:flex">
          <div class="text-center sm:mx-auto sm:w-11/12 md:mt-12 md:w-4/5 lg:mt-0 lg:mr-auto lg:w-6/12 lg:text-left">
            ...
            <form action="" class="mt-12">
              <div
                ...
                <div class="py-3 pl-4 lg:pl-5">
                  <svg xmlns="http://www.w3.org/2000/svg" class="m-auto h-6 w-6 fill-gray-500 dark:fill-gray-400"
                ...
                <div class="md:pr-1.5 lg:pr-0">
                  <button type="submit" title="Start buying"
                    ...
                    <span class="relative hidden w-max font-semibold text-white dark:text-gray-900 md:block">
                      Get Started
                    </span>
            ...
            <div class="mt-12 hidden lg:block">
              <span class="text-gray-700 dark:text-white">From the most talented
                <NuxtLink :to="{ name: 'team' }" class="text-blue-500 underline dark:text-blue-500">
                  Teams
                </NuxtLink>
                !
              </span>
          ...
          <div class="mt-12 w-full overflow-hidden sm:mt-20 lg:-mt-8 lg:w-6/12">
            <img class="w-full" src="/images/team.svg" alt="team illustration" height="600" width="800" />
          </div>
        </div>
        <div class="mt-12 border-y border-gray-100 py-8 text-center dark:border-gray-800 md:py-12 xl:mt-20">
          <NuxtLink :to="{ name: 'team' }" class="text-sm font-semibold tracking-wider text-gray-800 dark:text-white">
          ...
          <div
            ...
            <img class="h-8 w-auto lg:h-10 lg:w-auto" src="/images/clients/airbnb.svg" loading="lazy" alt="airbnb"
              width="" height="" />
            <img class="h-8 w-auto lg:h-10 lg:w-auto" src="/images/clients/coty.svg" loading="lazy" alt="bissell" width=""
              height="" />
            <img class="h-8 w-auto lg:h-10 lg:w-auto" src="/images/clients/ge.svg" loading="lazy" alt="ge" width="100"
              height="100" />
            <img class="h-8 w-auto lg:h-10 lg:w-auto" src="/images/clients/lilly.png" loading="lazy" alt="lilly" width=""
              height="" />
            <img class="h-8 w-auto lg:h-10 lg:w-auto" src="/images/clients/microsoft.svg" loading="lazy" alt="microsoft"
              width="" height="" />
          </div>
        </div>
      </div>
