<template>
  <section class="relative py-32">
    <div
      ...
      <div
        class="h-60 bg-gradient-to-br from-blue-500 to-purple-400 blur-[106px] dark:from-blue-700"></div>
      <div
        class="h-40 bg-gradient-to-r from-cyan-400 to-sky-300 blur-[106px] dark:to-indigo-600"></div>
    </div>
    <div class="relative mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      ...
      <div
        class="mt-16 grid gap-8 sm:mx-auto sm:w-2/3 md:w-full md:grid-cols-2 lg:grid-cols-3">
        <div
          ...
          <div class="space-y-12 text-center">
            ...
            <div class="space-y-6">
              ...
              <p class="text-gray-600 dark:text-gray-300">
                ...
                nesciunt neque culpa hic illum ab qui error repellendus
        ...
        <div
          class="rounded-3xl border border-gray-100 bg-white p-8 py-12 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
          <div class="space-y-12 text-center">
            <img
            ...
            <div class="space-y-6">
              ...
              <a
                aria-label="read more"
                href="#"
                class="group relative mx-auto flex h-12 w-12 items-center justify-center before:absolute before:inset-0 before:rounded-full before:border before:border-gray-600 before:bg-transparent before:bg-gradient-to-b before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
