<template>
  <section class="relative py-32">
    <div
      aria-hidden="true"
      class="absolute inset-0 top-60 grid grid-cols-2 -space-x-52 opacity-50">
      <div
        class="h-60 bg-gradient-to-br from-blue-500 to-purple-400 blur-[106px]"></div>
      <div
        class="h-40 bg-gradient-to-r from-cyan-400 to-sky-300 blur-[106px]"></div>
    </div>
    <div class="relative mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
      ...
      <div
        ...
        <div
          class="rounded-3xl border border-gray-100 bg-white p-8 py-12 shadow-2xl shadow-gray-600/10 sm:p-12">
            ...
            <div class="space-y-6">
              ...
              <a
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  class="relative h-5 w-5 text-gray-600 transition duration-300 group-hover:translate-x-1">
                  <path
                    fill-rule="evenodd"
