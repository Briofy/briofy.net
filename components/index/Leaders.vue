      ...
      <div class="mt-12 grid gap-8 md:grid-cols-2">
        <div
          ...
          <div class="flex h-full flex-col justify-center space-y-6 md:space-y-8">
            <img class="mr-auto h-12 w-auto" src="/images/clients/microsoft.svg" loading="lazy" alt="microsoft" />
            ...
            <div class="flex items-center gap-3">
              <img class="h-12 w-12 rounded-full" src="/images/avatars/avatar-2.webp" loading="lazy" alt="user avatar"
                width="200" height="200" />
              <div>
                <h3 class="text-lg font-semibold leading-none text-gray-600 dark:text-gray-200">
                  Andy Doe
                </h3>
        ...
        <div
          ...
          <img class="h-12 w-auto" src="/images/clients/airbnb.svg" loading="lazy" alt="airbnb" />
          <p class="text-gray-600 dark:text-gray-300">
            <span class="font-serif">"</span>Sit amet consectetur adipisicing
            elit. Quaerat repellat perspiciatis excepturi est. Provident, omnis
            ut, sapiente veritatis cum deleniti repudiandae ad doloribus.
            <span class="font-serif">"</span>
          </p>
          <div class="flex items-center gap-3 text-left">
            <img class="h-12 w-12 rounded-full" src="/images/avatars/avatar-3.webp" alt="user avatar" width="200"
        ...
        <div
          class="space-y-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
          <img class="h-12 w-auto" src="/images/clients/ge.svg" loading="lazy" alt="ge" />
          <p class="text-gray-600 dark:text-gray-300">
            <span class="font-serif">"</span>Sit amet consectetur adipisicing
            elit. Quaerat repellat perspiciatis excepturi est. Provident, omnis
            ut, sapiente veritatis cum deleniti repudiandae ad doloribus.
          ...
          <div class="flex items-center gap-3 text-left">
            <img class="h-12 w-12 rounded-full" src="/images/avatars/avatar-4.webp" alt="user avatar" width="200"
              height="200" loading="lazy" />
            <div>
              <h3 class="text-lg font-semibold leading-none text-gray-600 dark:text-gray-200">
                John Doe
