<template>
  <header>
    <nav
      class="shadow-md dark:shadow-md bg-white fixed top-0 inset-x-0 z-20 w-full border-b bg-white/80 backdrop-blur navbar-active navbar-active dark:border-gray-700 dark:bg-gray-900/80 border-gray-100 px-4 lg:px-6 py-2.5">
      <div
        ...
        <div class="flex items-center gap-2 lg:order-2">
          ...
          <button
            ...
            class="inline-flex items-center text-gray-900 dark:text-gray-300 font-medium rounded-lg text-sm px-2 lg:px-4 py-2 lg:py-2.5 mr-2 md:mr-3 focus:outline-none dark:focus:ring-gray-800">
            <svg
          ...
          <a
            href="#"
            class="text-blue-600 dark:text-blue-500 dark:hover:text-white lg:ml-3 focus:ring-4 font-medium rounded-lg text-sm px-3 lg:px-5 py-2 lg:py-2.5 focus:outline-none"
            >Log out</a
          >
          <button
        ...
        <div
          class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 text-center"
          id="mobile-menu-2">
          <ul
            ...
            <li>
              <a
                href="#"
                class="block py-2 pr-4 pl-3 text-blue-600 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-blue-500 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                aria-current="page"
                >Home</a
              >
            </li>
            <li>
              <button
                ...
                class="flex justify-center items-center py-2 pr-4 pl-3 w-full font-medium text-gray-700 border-b border-gray-100 lg:w-auto hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-600 lg:p-0 dark:text-gray-400 lg:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">
                Company
                <svg
    ...
    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-800">
      <div
        ...
        <div class="flex items-center">
          ...
          >
          <span
            class="mr-0 ml-2 w-px h-5 bg-gray-200 dark:bg-gray-600 lg:inline lg:mr-3 lg:ml-5"></span>
          <a
            href="#"
...
const navLinks = ref([
  ...
  { title: "Company", link: "", hasDropdown: "true" },
  { title: "Marketplace", link: "/market-place", hasDropdown: "false" },
  { title: "Features", link: "/features", hasDropdown: "false" },
  { title: "Team", link: "/team", hasDropdown: "false" },
