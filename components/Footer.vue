<template>
      ...
      <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
        <div class="col-span-2">
          <a href="#" class="flex items-center">
            <img src="/images/logo/logo.png" class="w-52" />
          </a>
  ...
  <footer class="border-t border-gray-100 pb-8 dark:border-gray-800">
    <div>
      <div
        ...
        <div class="grid grid-cols-8 gap-6 md:gap-0">
          <div class="col-span-8 md:col-span-2 lg:col-span-3">
            <div
              ...
              <div>
                <a href="/index.html" class="flex items-center mt-6 mb-4">
                  <img src="/images/logo/logo.svg" class="h-14" />
                </a>
                <a href="https://tailus.io" class="mt-2 inline-block text-sm"
                  >Briofy is a open-source library of over 400+ web components
          ...
          <div class="col-span-8 md:col-span-6 lg:col-span-5 pt-14">
            ...
            <span
              class="block text-sm text-center lg:text-start text-gray-500 dark:text-gray-400"
              >© 2021-2022
              <NuxtLink :to="{ name: 'index' }" class="hover:underline"
                >Briofy™</NuxtLink
              >. All Rights Reserved.</span
