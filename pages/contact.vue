    ...
    <div class="py-16 px-4 mx-auto -mt-96 max-w-screen-xl sm:py-24 lg:px-6">
      ...
      <div
        ...
        <div>
          ...
          <a
            href="#"
            class="inline-flex py-2 px-4 text-sm font-medium text-center rounded-lg border text-blue-600 border-blue-600 hover:text-white hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300"
            >Support center</a
          >
        </div>
      </div>
